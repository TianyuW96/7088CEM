...
model = tf.keras.Sequential([
    SimpleRNN(80, return_sequences=True),       # On the first loop calculation side, the memory is set to 80.
    Dropout(0.2),                               # To prevent overfitting, use a Dropout of 0.2
    SimpleRNN(100),                             # On the second-level loop calculation side, the memory is set to 100.
    Dropout(0.2),
...
checkpoint_save_path = "./checkpoint/NRNN.ckpt"
